...
#SBATCH --output=att_model_sree_output.txt
#SBATCH --error=att_model_sree_error.txt
#SBATCH --job-name="att_model_sree"
#SBATCH -n 20
...
python3 ~/work/LP-IOANet/ada_sripts/script_with_att_4000.py
echo "trained model"
