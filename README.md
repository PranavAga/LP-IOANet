...
# Implementation and Extenstion of LP-IOANET: (EFFICIENT HIGH RESOLUTION DOCUMENT SHADOW REMOVAL)

PyTorch implementation with pretrained layers of [*MobileNET*](https://arxiv.org/pdf/1704.04861.pdf).
